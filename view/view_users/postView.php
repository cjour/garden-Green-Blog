...
<section class="container-fluid">
    ...
    <div class="row d-flex flex-column align-items-center">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <?php } else if ($_SESSION['statut'] == 2) { ?>
                            ...
                            <a class="Btn_link" href="index.php?action=deleteComment&amp;idComment=<?=$comment['id']?>&amp;idPost=<?=$post['id']?>"><button class="btn btn-info">Confirmer</button></a>
        ...
        for($i=1;$i<=ceil($totalNumberOfComments/$commentManager->_limit);$i++) {
        if($i == $commentManager->_currentPage) {
        echo $i.' ';
        } else {
        echo '<a href="index.php?action=getAPost&id=' . $_GET['id'] . '&page='.$i.'">'.$i.'</a> ';
        }
        } ?>
    </div>
</section>        
